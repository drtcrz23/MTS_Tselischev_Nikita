...
import com.example.bookratingservice.exceptions.BookRatingException;
...
public class Producer {
  ...
  public void stubRating(@PathVariable @NotNull Long bookId) throws JsonProcessingException {
    ...
    String message = objectMapper.writeValueAsString(new BookRatingResponse(bookId, rating));
